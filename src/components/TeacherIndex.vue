    ...
    <el-aside style="background-color: rgb(238, 241, 246)" width="200px">
      <el-menu
        ...
        <el-submenu index="1">
          ...
          <el-menu-item-group>
            <el-menu-item index="/TeacherIndex">仪表盘</el-menu-item>
        ...
        <el-submenu index="3">
          ...
          <el-menu-item-group>
            <el-menu-item index="/TeacherIndex/TeacherHealth">健康申报</el-menu-item>
            <el-menu-item index="/TeacherIndex/TeacherHealthRecord">个人申报记录</el-menu-item>
            <el-menu-item index="/TeacherIndex/StudentHealthRecordTeacher">学生申报记录</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
        ...
        <el-submenu index="4">
          ...
          <el-menu-item-group>
            <el-menu-item index="/TeacherIndex/UpdatePassword">修改密码</el-menu-item>
            <el-menu-item index="/TeacherIndex/MyInformation">修改信息</el-menu-item>
